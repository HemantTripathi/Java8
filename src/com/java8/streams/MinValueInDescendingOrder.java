...
public class MinValueInDescendingOrder {
	public static void main(String[] args) {
		...
		Integer minimumMarks = markslist.stream().min((i1,i2)->i2.compareTo(i1)).get();
		System.out.println("Lowest marks by student using min():"+minimumMarks);
		
		Integer maximumMarks = markslist.stream().max((i1,i2)->i2.compareTo(i1)).get();
